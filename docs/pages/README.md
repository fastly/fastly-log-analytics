...
## 1. AI Agent Operating Protocol: Inquire, Clarify, and Document Before Execution

Before beginning implementation, testing, or refactoring on any page specification:
