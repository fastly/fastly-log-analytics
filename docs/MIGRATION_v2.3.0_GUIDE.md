...
Version 2.2 introduces a **declarative VCL reconciliation system** that automatically detects and removes legacy VCL snippets from pre-2.2 deployments, replacing them with consolidated, feature-unified snippets. This guide explains how the migration works and what users will experience.
