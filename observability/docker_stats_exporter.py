...
def _collect_once() -> str:
    lines = [
        ...
        "# HELP container_fs_reads_bytes_total Cumulative container filesystem bytes read.",
        "# TYPE container_fs_reads_bytes_total counter",
        "# HELP container_fs_writes_bytes_total Cumulative container filesystem bytes written.",
    ...
    for c in containers:
        ...
        fs_reads, fs_writes = _block_io_bytes(stats)
        ...
        lines.append(f"container_fs_reads_bytes_total{{{labels}}} {fs_reads}")
        lines.append(f"container_fs_writes_bytes_total{{{labels}}} {fs_writes}")
