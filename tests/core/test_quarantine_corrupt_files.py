...
def test_quarantine_corrupt_files_uploads_only_bad_lines_and_records_the_file():
    ...
    _clear(service_id)
    key = "raw/request/year=2026/month=08/day=27/hour=13/minute=00/batch.json.gz"
    fos = MagicMock()
    ...
    assert keys == [
        "errors/year=2026/month=08/day=27/hour=13/minute=00/batch.json.bad.jsonl",
        "errors/year=2026/month=08/day=27/hour=13/minute=00/batch.json.bad.jsonl.meta.json",
    ]
...
def test_quarantine_corrupt_files_attributes_lines_to_the_right_file():
    ...
    _clear(service_id)
    key_a = "raw/request/year=2026/month=08/day=27/hour=13/minute=01/a.json.gz"
    key_b = "raw/request/year=2026/month=08/day=27/hour=13/minute=02/b.json.gz"
    fos = MagicMock()
    ...
    assert bodies["errors/year=2026/month=08/day=27/hour=13/minute=01/a.json.bad.jsonl"] == b"a-bad-1\na-bad-2"
    assert bodies["errors/year=2026/month=08/day=27/hour=13/minute=02/b.json.bad.jsonl"] == b"b-bad-1"
...
def test_quarantine_corrupt_files_honors_the_source_prefix():
    ...
    _clear(service_id)
    key = "tenant-b/raw/request/year=2026/month=08/day=27/hour=13/minute=03/p.json.gz"
    fos = MagicMock()
    ...
    keys = [c.kwargs["Key"] for c in fos.put_object.call_args_list]
    assert keys[0] == "tenant-b/errors/year=2026/month=08/day=27/hour=13/minute=03/p.json.bad.jsonl"
...
def test_quarantine_corrupt_files_skips_a_file_with_no_corrupt_lines():
    ...
    _clear(service_id)
    key = "raw/request/year=2026/month=08/day=27/hour=13/minute=04/clean.json.gz"
    fos = MagicMock()
...
def test_quarantine_corrupt_files_skips_a_key_outside_the_raw_prefix():
    ...
    _clear(service_id)
    key = "raw/rum/2026/08/27/13/05/beacon.json.gz"
    fos = MagicMock()
...
def test_quarantine_corrupt_files_is_best_effort_per_file():
    ...
    _clear(service_id)
    key_bad = "raw/request/year=2026/month=08/day=27/hour=13/minute=06/explodes.json.gz"
    key_ok = "raw/request/year=2026/month=08/day=27/hour=13/minute=07/fine.json.gz"
    fos = MagicMock()
...
def test_quarantine_corrupt_files_caps_the_stored_samples():
    ...
    _clear(service_id)
    key = "raw/request/year=2026/month=08/day=27/hour=13/minute=08/many.json.gz"
    fos = MagicMock()
    long_line = "x" * 3000
