...
# ── FINGERPRINT_TOP_N ─────────────────────────────────────────────────────────
# Shared template used by the fingerprint card(s), parameterised by column name
# so sibling fingerprint columns can reuse it without drifting. The
# consolidation lives in backend/repositories/_sql/security.py.
