...
from backend.utils.remote_access import _ANALYST_ALLOWED_WRITE_PREFIXES, _is_blocked_path
...
def _verb_gate_blocks(method: str, substituted_path: str) -> bool:
    ...
    refused for analysts, and POST is refused unless the path starts with an
    ``_ANALYST_ALLOWED_WRITE_PREFIXES`` entry. Kept in lockstep with that
