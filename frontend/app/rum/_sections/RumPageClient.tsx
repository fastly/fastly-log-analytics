        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Once deployed, real user beacons will automatically be sent to your analytics dashboard when users visit your site. After collecting 10+ beacons, you'll see real performance data appear on this page.
              </p>
            </div>
