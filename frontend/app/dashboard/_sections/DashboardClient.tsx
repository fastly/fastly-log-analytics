...
export default function DashboardClient() {
  ...
  // page session (it floors to the 60s grid; pinning avoids advancing the key on
  // a cross-minute re-render, which would refire the bundle). quantizeAnchor
  // mirrors backend quantize_anchor byte-for-byte; the SSR helper floors the
  // SAME way, so the seed + this key agree within the quantum.
