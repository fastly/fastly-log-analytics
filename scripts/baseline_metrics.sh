...
#
# Outputs to: .metrics/baseline/<UTC-timestamp>/  (gitignored; generated)
...
# uses this AND the since-removed audit-findings/ remediation log. Phase 0.8
# sets the pytest mark up; this is the source-comment counterpart.
