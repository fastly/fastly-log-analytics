...
# Resolve GCP/Elevation parameters with default fallbacks
...
elevation_namespace = os.getenv("ELEVATION_NAMESPACE", "se-demo")
...
ENVIRONMENTS: dict[str, EnvironmentTarget] = {
    "local-standard": EnvironmentTarget(
        ...
        fastly_service_id="ZU15BvY2LX7WcEp43T9VwU",
    ...
    "local-high-scale": EnvironmentTarget(
        ...
        fastly_service_id="qI4D8yXXFYOIpZEMrkJy65",
        remediation_cmd=(
    ...
    "remote-standard": EnvironmentTarget(
        ...
        fastly_service_id="cVnu9mYB3Cvmob3lsqjQU3",
    ...
    "remote-high-scale": EnvironmentTarget(
        ...
        fastly_service_id="ZEZ4mcAjoSFDTg7tpkDKV2",
        remediation_cmd=os.getenv(
